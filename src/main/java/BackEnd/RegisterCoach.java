...
public class RegisterCoach {
    ...
    public static boolean registerCoach(String name, String username, String email, int phoneNumber, String password,
           String type) {
        String url = "jdbc:sqlserver://vsc23.database.windows.net:1433;database=VSC";
        String user = "IntelliJ";
        String dbPassword = "vsc.DAI23";
        ...
        try {
            ...
            String sql = "INSERT INTO [dbo].[Coach] ([name],[username], [password], [team_id],[phone_number],[email],[type]) " +
                    "VALUES ( ? , ? , ? , ? , ? , ? , ?)";
